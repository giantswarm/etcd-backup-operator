...
func (u *Utils) GetTenantClusters(ctx context.Context, backup v1alpha1.ETCDBackup) ([]resource.ETCDInstance, error) {
	var instances []resource.ETCDInstance
	...
	for _, cluster := range clusterList {
		...
		instances = append(instances, resource.ETCDInstance{
